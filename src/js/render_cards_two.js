...
// Змінна markup містить масив елементів, які будуть відображені на сторінці, створюються з допомогою методу масиву map, де перебирається massiveMovies
// та створюється HTML - розмітка для кожного елементу масиву.
