...
export const galleryTeam = [
  {
    id: 1,
    name: 'Stanislav Zaliskyi',
    photoPreview: `${stanislavUrl}`,
    photo: `${stanislavPhoto}`,
    position: 'Team Lead',
  },
  {
    id: 2,
    name: 'Nastya Ovcharenko',
    photoPreview: `${nastyaUrl}`,
    photo: `${nastyaPhoto}`,
    position: 'Scrum Master',
  },
  {
    id: 3,
    name: 'Serhii Lytvynenko',
    photoPreview: `${serhiiUrl}`,
    photo: `${serhiiPhoto}`,
    position: 'Developer',
  },
  {
  ...
  },
  {
    id: 5,
    name: 'Mykola Kuts',
    photoPreview: `${mykolaUrl}`,
    photo: `${mykolaPhoto}`,
    position: 'Developer',
  },
  {
    id: 6,
    name: 'Nataliia Matsko',
    photoPreview: `${nataliiaUrl}`,
    photo: `${nataliiaPhoto}`,
    position: 'Developer',
  },
  {
    id: 7,
    name: 'Ruslan Borysevych',
    photoPreview: `${ruslanUrl}`,
    photo: `${ruslanPhoto}`,
    position: 'Developer',
  },
  {
  ...
  },
  {
    id: 9,
    name: 'Vadym Kolisnyk',
    photoPreview: `${vadymUrl}`,
    photo: `${vadymPhoto}`,
    position: 'Developer',
  },
  {
    id: 10,
    name: 'Anastasiia Berehovyh',
    photoPreview: `${anastasiiaUrl}`,
  ...
  },
  {
    id: 11,
    name: 'Taras Fedak',
    photoPreview: `${tarasUrl}`,
    photo: `${tarasPhoto}`,
    position: 'Developer',
  },
  {
    id: 12,
    name: 'Tetiana Asadova',
    photoPreview: `${tetianaUrl}`,
    photo: `${tetianaPhoto}`,
    position: 'Developer',
  },
  {
